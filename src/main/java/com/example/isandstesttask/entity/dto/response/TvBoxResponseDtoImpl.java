...
public class TvBoxResponseDtoImpl extends BaseProductResponseDtoImpl implements TvBoxResponseDto {
    ...
    public TvBoxResponseDtoImpl(UUID id, String productType, String producingCountry, String brandName, boolean isOnlineOrdering, boolean isSoldByInstallments, boolean isAvailable, String modelName, String serialNumber, String colorName, BigDecimal price, String size, String category, String technology) {
