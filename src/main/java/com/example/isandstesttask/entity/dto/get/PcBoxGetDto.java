...
public class PcBoxGetDto {
    ...
    private final Optional<String> processorType;
    ...
    public PcBoxGetDto(Optional<BigDecimal> minPrice, Optional<BigDecimal> maxPrice, Optional<String> color, Optional<String> brand, Optional<String> category, Optional<String> country, Optional<String> serial, Optional<String> model, Optional<String> size, Optional<String> processorType, Optional<Boolean> available, Optional<Boolean> isOnlineOrdering, Optional<Boolean> isSoldByInstallments, Optional<VacuumCleanerSortedFields> sortBy, Optional<SortDirection> sortType) {
    ...
    public Optional<String> getProcessorType() {
